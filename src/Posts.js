...
function ItemPost(props){
  ...
  <div class="post">
          ...
          <div class="conteudo">
            <img src={props.conteudo} alt ="conteudo" onClick={ event => {if (event.detail === 2) {(coracao === coracaoVazio? curtir():descurtir())}}}/>
          </div>

          <div class="fundo">
            <div class="acoes">
              <div>
                <ion-icon name={coracao} onClick ={(coracao === coracaoVazio? curtir:descurtir)} style={{color:corCoracao}}></ion-icon>
                <ion-icon name="chatbubble-outline"></ion-icon>
                <ion-icon name="paper-plane-outline"></ion-icon>
              </div>
              <div>
                <ion-icon name={salvo} onClick = {(salvo === naoSalvo? salvar:desmarcarSalvar)}></ion-icon>
              </div>
            </div>
